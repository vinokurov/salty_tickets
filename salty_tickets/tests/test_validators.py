...
from salty_tickets.models.tickets import WorkshopTicket, Ticket
...
def test_at_least_any_with_tag():
    products = {
        'w1': Ticket(name='W1', tags={'workshop'}),
        'w2': Ticket(name='W2', tags={'workshop'}),
        'w3': Ticket(name='W3', tags={'workshop'}),
        'p': Ticket(name='P', tags={'party'})
    }
    ...
    registrations = [
        Registration(person=mr_x, registered_by=mr_x, ticket_key='p')
    ]
...
def test_non_overlapping():
    products = {
        'w1': WorkshopTicket(name='W1', tags={'workshop'}, start_datetime=datetime(2018, 9, 23, 11, 0)),
        'w2': WorkshopTicket(name='W2', tags={'workshop'}, start_datetime=datetime(2018, 9, 23, 11, 0)),
        'w3': WorkshopTicket(name='W3', tags={'workshop'}, start_datetime=datetime(2018, 9, 23, 16, 0)),
        'p': Ticket(name='P', tags={'party'})
    }
    ...
    registrations = [
        ...
        Registration(person=mr_x, registered_by=mr_x, ticket_key='w3'),
        Registration(person=ms_y, registered_by=mr_x, ticket_key='w1'),
        Registration(person=ms_y, registered_by=mr_x, ticket_key='w3'),
        Registration(person=mr_x, registered_by=mr_x, ticket_key='p'),
    ]
