...
from salty_tickets.to_delete.sql_models import Event, OrderProduct, Order, Registration, ORDER_PRODUCT_STATUS_WAITING, SignupGroup, \
...
from salty_tickets.to_delete.products import get_product_by_model
