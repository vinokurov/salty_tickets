...
import pytest
from salty_tickets.forms import FormWithProducts
from salty_tickets.to_delete.products import CouplesOnlyWorkshop, RegularPartnerWorkshop, WorkshopRegStats
from salty_tickets.to_delete.sql_models import Product, Event, DANCE_ROLE_LEADER, DANCE_ROLE_FOLLOWER
